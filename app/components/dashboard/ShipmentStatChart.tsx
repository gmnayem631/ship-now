...
const CustomTooltip = ({ active, payload }: any) => {
  if (active && payload && payload.length) {
    ...
    return (
      <div className="min-w-25 rounded-2xl border border-purple-200/50 bg-[#e4d9ff] px-4 py-2.5 text-center shadow-sm">
...
export default function ShipmentStatisticChart() {
  ...
  return (
    <div className="w-full max-w-lg rounded-3xl border border-gray-100 bg-white p-6 font-sans shadow-sm">
      {/* Header */}
